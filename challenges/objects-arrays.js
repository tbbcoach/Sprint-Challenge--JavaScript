...
const uniwithUni = graduates.filter(
(graduate) => {return graduate.university.includes('Uni')});
...
const displayNames = [];
  ...
  zooAnimals: `Name: ${zooAnimals.animal_name}  Scientific: ${zooAnimals.scientific_name}`
  })
...
*/
const populationTotal = zooAnimals.reduce((accumulator, animalpop) => {
  return animalpop.population + accumulator
}, 0);
